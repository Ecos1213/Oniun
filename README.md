...
# React
La carpeta oniun-frontend es donde se aloja React y primero se debera instalar las dependecias con npm install. El proyecto tendrá que correr con el comando npm run start y tendrá que correr por el puerto 3000, para iniciar sesión se puede usar el usuario: anaforero@oniun.com y contraseña: U123456*
